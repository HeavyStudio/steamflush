<script lang="ts">
    ...
    import GitHubLogo from "../assets/images/GitHub_Invertocat_White.svg";

    function openGitHub() {
        BrowserOpenURL("https://github.com/HeavyStudio/steamflush");
    }
</script>
...
<style>
    .app-footer {
        display: flex;
        justify-content: space-between; /* Pour séparer gauche et droite */
        align-items: center;
        padding: 14px 24px;
